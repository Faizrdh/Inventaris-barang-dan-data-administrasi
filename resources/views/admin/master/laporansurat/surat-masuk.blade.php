                        ...
                        <table id="data-tabel" width="100%" class="table table-bordered text-nowrap border-bottom dataTable no-footer dtr-inline collapsed">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0" width="12%">{{__('received date')}}</th>
                                    <th class="border-bottom-0" width="12%">{{__('letter code')}}</th>
                                    <th class="border-bottom-0" width="15%">{{__('letter name')}}</th>
                                    <th class="border-bottom-0" width="12%">{{__('category')}}</th>
                                    <th class="border-bottom-0" width="15%">{{__('sender')}}</th>
                                    <th class="border-bottom-0" width="15%">{{__('from department')}}</th>
                                    <th class="border-bottom-0" width="8%">{{__('file status')}}</th>
                                    <th class="border-bottom-0" width="10%">{{__('received by')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
            ...
            buttons: [
                {
                    ...
                    filename: function() {
                        ...
                        return `laporan-surat-masuk-${startDate}-sampai-${endDate}`;
                    },
                    exportOptions: {
